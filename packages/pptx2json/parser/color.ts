...
export function hslToRgb(hue: number, sat: number, light: number): { r: number; g: number; b: number } {
  let t2
  hue = hue / 60
  if (light <= 0.5) {
    t2 = light * (sat + 1)
...
export function applyShade(rgbStr: string, shadeValue: number, isAlpha?: boolean): string {
...
export function applyTint(rgbStr: string, tintValue: number, isAlpha?: boolean): string {
  const color = tinycolor(rgbStr).toHsl()
...
export function applyLumOff(rgbStr: string, offset: number, isAlpha?: boolean): string {
  const color = tinycolor(rgbStr).toHsl()
...
export function applyLumMod(rgbStr: string, multiplier: number, isAlpha?: boolean): string {
  const color = tinycolor(rgbStr).toHsl()
...
export function applyHueMod(rgbStr: string, multiplier: number, isAlpha?: boolean): string {
  const color = tinycolor(rgbStr).toHsl()
...
export function applySatMod(rgbStr: string, multiplier: number, isAlpha?: boolean): string {
  const color = tinycolor(rgbStr).toHsl()
